...
const trips = (ids) => [
  ...
  },
  {
    ...
    pricePerLb: 0.02,
    pickupInstructions: "Drop off at our DC warehouse",
    dropoffInstructions: "Banjul port pickup",
    allowedItemTypes: ["Clothes", "Documents", "Electronics", "Food", "Other"],
    status: "PUBLISHED",
  },
  {
    id: "seed-trip-nyc",
